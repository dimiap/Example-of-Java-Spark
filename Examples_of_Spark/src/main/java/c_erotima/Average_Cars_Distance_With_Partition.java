...
import scala.Tuple2;
//doing a partition to the last query
public class Average_Cars_Distance_With_Partition {
	public static void main(String[] args) {
		...
		JavaPairRDD<String, Double> averagePair2 = reducedCount.mapToPair(getAverageByKey).repartition(3); // kanoume
																											// partition
		...
		averagePair2.foreach(data -> {
			System.out.println("Car=" + data._1() + "\t" + " Average=" + data._2()); // gia na doume tn diafora ston
																						// xrono metaksi tou project
																						// xoris partition
		});
